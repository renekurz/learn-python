# 🐍 Day 04 – Randomisation & Python Lists

Welcome to **Day 04** of the Python learning journey!
Today introduces randomisation in Python and working with lists to store and manage collections of data.
...
```bash
cd day-04_Beginner_Randomisation-and-Lists
...
The **Rock Paper Scissors Game** uses randomness and lists to simulate gameplay.
Try enhancing it by:

- Adding score tracking
- Implementing input validation
- Creating multiple rounds
- Adding improved ASCII visuals
